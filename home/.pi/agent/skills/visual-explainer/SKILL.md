...
**Usage:**
```bash
bash /Users/ryanmiville/.pi/agent/skills/visual-explainer/scripts/share.sh <html-file>
```

**Example:**
```bash
bash /Users/ryanmiville/.pi/agent/skills/visual-explainer/scripts/share.sh ~/.agent/diagrams/my-diagram.html
